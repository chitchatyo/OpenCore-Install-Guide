...
* AMD's GCN based GPUs are supported in the latest versions of macOS
  * AMD APUs are supported thanks to [NootedRed](https://github.com/ChefKissInc/NootedRed)
  * AMD's [Lexa based cores](https://www.techpowerup.com/gpu-specs/amd-lexa.g806) from the Polaris series are not supported
